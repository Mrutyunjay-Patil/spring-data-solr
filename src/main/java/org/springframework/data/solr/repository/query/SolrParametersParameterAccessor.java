...
public class SolrParametersParameterAccessor implements SolrParameterAccessor {
	...
	public ScrollPosition getScrollPosition() {
		// Since Solr typically uses start and rows for pagination rather than a scroll position,
		// and if scrolling is not relevant to your use case, you can return null.
		return null;
	}
