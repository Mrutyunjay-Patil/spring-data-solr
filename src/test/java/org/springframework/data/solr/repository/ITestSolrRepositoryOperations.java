...
public class ITestSolrRepositoryOperations {
	...
	public void setUp() {
		repo.deleteAll();
		repo.saveAll(
				Arrays.asList(POPULAR_AVAILABLE_PRODUCT, UNPOPULAR_AVAILABLE_PRODUCT, UNAVAILABLE_PRODUCT, NAMED_PRODUCT), Duration.ZERO);
	}
	...
	public void testFindOne() {
		ProductBean found = (ProductBean) repo.findById(POPULAR_AVAILABLE_PRODUCT.getId()).get();
		assertThat(found.getId()).isEqualTo(POPULAR_AVAILABLE_PRODUCT.getId());
	}

	@Test
	public void testFindOneThatDoesNotExist() {
		assertThat(repo.findById(POPULAR_AVAILABLE_PRODUCT.getId().concat("XX-XX-XX")).isEmpty()).isFalse();
	}
	...
	public void testFindByIsNull() {
		...
		repo.save(beanWithoutName, Duration.ZERO);
	...
	public void testFindByBefore() {
		...
		repo.saveAll(Arrays.asList(modifiedMid2012, modifiedMid2011), Duration.ZERO);
	...
	public void testFindByWithin() {
		...
		repo.saveAll(Arrays.asList(locatedInBuffalow, locatedInNYC), Duration.ZERO);
	...
	public void testFindWithSortAsc() {
		...
		repo.saveAll(values, Duration.ZERO);
	...
	public void testFacetAndHighlightWithFields() {
		...
		repo.save(beanWithText, Duration.ZERO);
	...
	public void testWithBoost() {
		...
		repo.saveAll(Arrays.asList(beanWithName, beanWithTitle), Duration.ZERO);
	...
	public void testWithDefTypeLucene() {
		...
		repo.save(anotherProductBean, Duration.ZERO);
	...
	public void testQueryWithRequestHandler() {
		...
		repo.save(availableBeanWithDescription, Duration.ZERO);
		...
		repo.save(unavailableBeanWithDescription, Duration.ZERO);
	...
	public void findTopNResultAppliesLimitationForPageableCorrectly() {
		...
		repo.saveAll(beans, Duration.ZERO);
	...
	public void findTopNResultReturnsEmptyListIfOusideOfRange() {
		...
		repo.saveAll(createProductBeans(10, "top"), Duration.ZERO);
	...
	public void sliceShouldReturnCorrectly() {
		...
		repo.saveAll(createProductBeans(10, "slice"), Duration.ZERO);
	...
	public void testStatsAnnotatedMethod() {
		...
		repo.save(created, Duration.ZERO);
	...
	public void testFindByNameWithSpellcheckSeggestion() {
		...
		repo.save(greenProduct, Duration.ZERO);
	...
	public void derivedFinderUsingEnum() {
		...
		repo.saveAll(Arrays.asList(html, json), Duration.ZERO);
