...
public class SimpleStatsResultTests {
	...
	public void testGetMinDouble() {
		...
		// Provide a description using a lambda expression
		assertThat(stats.getMinAsDate()).as(() -> "Description of the assertion").isNull();
	}
	...
	public void testGetMaxDouble() {
		...
		assertThat(stats.getMaxAsDate()).as(() -> "Description of the assertion").isNull();
	}
