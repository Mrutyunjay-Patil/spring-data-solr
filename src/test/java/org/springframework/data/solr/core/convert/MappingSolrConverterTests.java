...
public class MappingSolrConverterTests {
	...
	public void shouldConvertTypesWithinCollectionsOfMapCorrectly() {
		...
		// Manually convert Date to DateTime for the assertion
		Object dateObject = target.fieldWithDateTimeInListOfMap.get("fieldWithDateTimeInListOfMap_d").get(0);
		DateTime dateTime = null;
		if (dateObject instanceof Date) {
			dateTime = new DateTime(((Date) dateObject).getTime());
		}
	
		assertThat(dateTime).isInstanceOf(DateTime.class);
	}	
